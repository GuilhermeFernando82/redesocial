  ...
  <div class="collapse navbar-collapse" id="textoNavbar">
     <ul class="navbar-nav mr-auto"> 
          ...
          <div class="dropdown-menu bg-dark">
            <a class="dropdown-item bg-dark text-white" href="{{route('profile.edit', auth()->user()->id)}}">Meu Perfil</a>
      ...
      <ul class="navbar-nav float-right" style="margin-left: 125vh;">
                        <!-- ============================================================== -->
