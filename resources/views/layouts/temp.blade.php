                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                @if($i->id == auth()->user()->id and $i->picture != null)
                                <div class="user-pic"><img src="{{$i->picture}}" alt="users" class="rounded-circle" width="40" /></div>
                                @else
                        ...
                        @endforeach
                        <!-- User Profile-->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/forum" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Ir para Forum</span></a></li>
